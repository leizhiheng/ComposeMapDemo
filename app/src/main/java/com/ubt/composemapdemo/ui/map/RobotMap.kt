...
data class VirtualWall(@PrimaryKey var id: Long, var left: Float, var top: Float, var right: Float, var bottom: Float, @Ignore var state: VirtualWallState = VirtualWallState.Idle) {
    ...
    constructor() : this(0, 0f, 0f, 0f, 0f, VirtualWallState.Idle)

    companion object {
        var MIN_WIDTH = dp2Px(50)

        fun getOriginalVirtualWall(): VirtualWall {
            return VirtualWall(System.nanoTime(), dp2Px(130f), dp2Px(300f), dp2Px(230f), dp2Px(400f), VirtualWallState.Editing)
        }
    }
